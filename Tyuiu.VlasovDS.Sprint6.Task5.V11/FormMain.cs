...
using Tyuiu.VlasovDS.Sprint6.Task5.V11.Lib;

namespace Tyuiu.VlasovDS.Sprint6.Task5.V11
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 4 Выполнил студент группы АСОиУб-23-3 Власов Дмитрий Сергеевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

...
using Tyuiu.VlasovDS.Sprint6.Task2.V7.Lib;

namespace Tyuiu.VlasovDS.Sprint6.Task2.V7
{
    public partial class FormMain_KRM : Form
    {
        ...
        {
            MessageBox.Show("Таск 2 Выполнил студент группы АСОиУб-23-3 Власов Дмитрий Сергеевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

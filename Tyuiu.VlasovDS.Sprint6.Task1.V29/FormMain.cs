...
using Tyuiu.VlasovDS.Sprint6.Task1.V29.Lib;

namespace Tyuiu.VlasovDS.Sprint6.Task1.V29
{
    public partial class FormMain_KRM : Form
    {
        ...
        {
            MessageBox.Show("Таск 1 Выполнил студент группы АСОиУб-23-3 Власов Дмитрий Сергеевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

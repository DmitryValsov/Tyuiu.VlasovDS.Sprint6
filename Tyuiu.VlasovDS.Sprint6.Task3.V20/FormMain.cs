...
using Tyuiu.VlasovDS.Sprint6.Task3.V20.Lib;

namespace Tyuiu.VlasovDS.Sprint6.Task3.V20
{
    public partial class FormMain_KRM : Form
    {
        ...
        {
            MessageBox.Show("Таск 3 Выполнил студент группы АСОиУб-23-3 Власов Дмитрий Сергеевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
